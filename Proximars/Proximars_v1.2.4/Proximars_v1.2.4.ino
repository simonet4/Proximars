...
// Quatrième version officielle du code arduino pour la serre proximars
// Modifications: Correction de l'envoi des données via le bluetooth et adaptation de l'alimentation externe, optimisation du bouton
// Détails: Rangé et commenté
...
// Broches
  // Digital
    ...
    #define led1 6  // Broche de données pour la première partie du ruban
    #define led2 7  // Broche de don nées pour la deuxième partie du ruban
    #define led3 8 // Broche de données pour la troisième partie du ruban
    #define NUM_LEDS 30  // Nombre de LED dans chaque partie du ruban
    SoftwareSerial BTserial(9, 10); // RX sur 12, TX sur 13 pour le module Bluetooth
  //Analog
    DHT dht(A0, DHT22);
  //I2C
